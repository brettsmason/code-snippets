...
class Building_Block_Meta_Box {
	...
	public function render_metabox( $post ) {
		...
		// Form fields.
		echo '	<p>';
		echo '		<label for="bb_html" class="bb_html_label">' . __( 'HTML', 'text_domain' ) . '</label>';
		echo '		<textarea id="bb_html" name="bb_html" class="bb_html_field widefat">' . esc_attr__( $bb_html ) . '</textarea>';
		echo '		<div class="bb_editor_container"><div id="bb_code_html" class="bb_code_editor">' . esc_attr__( $bb_html ) . '</div></div>';
		echo '	</p>';

		echo '	<p>';
		echo '		<label for="bb_css" class="bb_css_label">' . __( 'CSS', 'text_domain' ) . '</label>';
		echo '		<textarea id="bb_css" name="bb_css" class="bb_css_field widefat">' . esc_attr__( $bb_css ) . '</textarea>';
		echo '		<div class="bb_editor_container"><div id="bb_code_css" class="bb_code_editor">' . esc_attr__( $bb_css ) . '</div></div>';
		echo '	</p>';

		echo '	<p>';
		echo '		<label for="bb_js" class="bb_js_label">' . __( 'JavaScript', 'text_domain' ) . '</label>';
		echo '		<textarea id="bb_js" name="bb_js" class="bb_js_field widefat">' . esc_attr__( $bb_js ) . '</textarea>';
